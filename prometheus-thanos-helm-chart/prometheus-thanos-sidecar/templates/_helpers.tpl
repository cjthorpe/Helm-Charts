...
{{- define "prometheus.querier.labels" -}}
{{ include "prometheus.querier.matchLabels" . }}
{{ include "prometheus.common.metaLabels" . }}
{{- end -}}

{{- define "prometheus.querier.matchLabels" -}}
...
{{- define "prometheus.storegateway.labels" -}}
{{ include "prometheus.storegateway.matchLabels" . }}
{{ include "prometheus.common.metaLabels" . }}
{{- end -}}

{{- define "prometheus.storegateway.matchLabels" -}}
component: {{ .Values.storegateway.name | quote }}
{{ include "prometheus.common.matchLabels" . }}
{{- end -}}
...
{{/*
Create a fully qualified Prometheus querier name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "prometheus.querier.fullname" -}}
...
{{/*
Create a fully qualified Prometheus storegateway name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "prometheus.storegateway.fullname" -}}
{{- if .Values.storegateway.fullnameOverride -}}
{{- .Values.storegateway.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- printf "%s-%s" .Release.Name .Values.storegateway.name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s-%s" .Release.Name $name .Values.storegateway.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{/*
Create the name of the service account to use for the querier component
*/}}
{{- define "prometheus.serviceAccountName.querier" -}}
{{- if .Values.serviceAccounts.querier.create -}}
    {{ default (include "prometheus.querier.fullname" .) .Values.serviceAccounts.querier.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccounts.querier.name }}
{{- end -}}
{{- end -}}
...
{{/*
Create the name of the service account to use for the storegateway component
*/}}
{{- define "prometheus.serviceAccountName.storegateway" -}}
{{- if .Values.serviceAccounts.storegateway.create -}}
    {{ default (include "prometheus.storegateway.fullname" .) .Values.serviceAccounts.storegateway.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccounts.storegateway.name }}
{{- end -}}
{{- end -}}
